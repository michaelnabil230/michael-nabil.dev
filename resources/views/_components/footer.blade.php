<footer class="p-8 print:hidden">
    <div class="mb-6 flex justify-center">
        <ul class="flex gap-4">
            <li>
                <a href="https://twitter.com/michaelnabil230" target="_blank" class="text-gray-400 hover:text-gray-600">
    ...
    <p class="text-center text-xs text-gray-500">
        &copy; 2022 Michael Nabil.
        <a href="https://github.com/michaelnabil230/michael-nabil.dev" target="_blank"
            class="hover:text-gray-700 hover:underline focus:text-gray-700 focus:underline">
