            ...
            <div class="sm:flex">
                ...
                <div class="mt-4 sm:mt-0 sm:flex-grow">
                    <div class="markdown max-w-2xl text-base">
                        ...
                        <p>
                            <a href="{{ route('articles.index') }}" class="mr-2">Articles</a>
                            <a href="{{ route('contact') }}" class="mr-2">Contact</a>
                            <a href="{{ route('cv') }}" class="mr-2">Cv</a>
                        </p>
                    </div>

                    <p class="mt-8">
                        <a href="https://twitter.com/michaelnabil230" target="_blank"
                            class="inline-block text-gray-500 border-0 hover:text-gray-700 focus:text-gray-700">
                            <svg role="img" aria-label="Twitter" class="inline-block fill-current twitter"
                        ...
                        <a href="https://github.com/michaelnabil230" target="_blank"
                            class="ml-3 inline-block text-gray-500 border-0 hover:text-gray-700 focus:text-gray-700">
                            <svg role="img" aria-label="GitHub" class="inline-block fill-current github"
                                xmlns="http://www.w3.org/2000/svg" version="1.1"
                                xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                                viewBox="0 0 24 24" height="24" width="24">
                                <g transform="matrix(1,0,0,1,0,0)">
                        ...
                        <a href="https://www.linkedin.com/in/michael-nabil-230" target="_blank"
                            class="ml-3 inline-block text-gray-500 border-0 hover:text-gray-700 focus:text-gray-700">
                            <svg role="img" aria-label="LinkedIn" class="inline-block fill-current linkedin"
                                xmlns="http://www.w3.org/2000/svg" version="1.1"
                                xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                                viewBox="0 0 24 24" height="24" width="24">
                                <g transform="matrix(1,0,0,1,0,0)">
                    ...
                    <p class="mt-12 text-xs">
                        <a href="https://github.com/michaelnabil230/michael-nabil.dev" target="_blank"
                    ...
                    <img src="{{ asset('images/egypt.svg') }}" alt="Eg" class="mt-4 w-8">
                </div>
            </div>
        </div>
    </div>
