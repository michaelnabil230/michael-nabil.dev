    ...
    <div class="max-w-4xl mx-auto p-6 print:p-0 print:max-w-none">
        ...
        <div class="mt-6">
            <ul class="-m-1 flex flex-wrap text-sm sm:text-base">
                ...
                <li class="m-1 px-3 py-1 inline-flex items-center bg-blue-100 text-blue-800 rounded">
                    <img class="inline w-4 h-4" src="{{ asset('images/cv/tailwindcss.svg') }}" alt="tailwindcss icon">
        ...
        <h2 class="mt-6 text-xl uppercase tracking-wide">Professional Experience</h2>
        ...
        <div class="mt-6 sm:flex">
            ...
            <div class="mt-2 sm:mt-0 sm:ml-6">
                ...
                <p class="font-semibold">Sofate</p>
                <ul class="mt-3 pl-4 list-disc">
        ...
        <div class="mt-6 sm:flex">
            ...
            <div class="mt-2 sm:mt-0 sm:ml-6">
                <p class="text-lg font-bold">Senior Web Developer</p>
                <p class="font-semibold">M6twer</p>
                <ul class="mt-3 pl-4 list-disc">
                    <li>Back-end web development.</li>
                </ul>
            </div>
        ...
        <div class="mt-6 sm:flex">
            ...
            <div class="mt-2 sm:mt-0 sm:ml-6">
                ...
                <p class="font-semibold">Freelancer</p>
                <ul class="mt-3 pl-4 list-disc">
                    <li>Back-end web development.</li>
                    <li>
                        Web app development, including the creation of POS system with touch screen, receipt printer, and
                        cash drawer.
                    </li>
